...
def getHLT(name, isMC=True):
    ...
    if "Run2016" in condtag:
        if "Run2016H" in condtag:
            path_cut = combineHLT.get("Run2016H.%s" % dataset, 1)
            path = "Run2016H.%s" % dataset
        else:
...
files  = [
    ...
    # 
    # "/store/data/Run2018C/MuonEG/NANOAOD/Nano1June2019-v1/60000/1A103366-F35C-3C47-B9C2-6A45BE80F69F.root",
    # 
    # "/store/data/Run2016B_ver2/MuonEG/NANOAOD/Nano1June2019_ver2-v1/40000/97C85BCC-BAA2-BC4B-B63A-FD054772E86A.root",
    # "/store/data/Run2016B_ver2/MuonEG/NANOAOD/Nano1June2019_ver2-v1/40000/97C85BCC-BAA2-BC4B-B63A-FD054772E86A.root",
    # "/store/data/Run2016C/MuonEG/NANOAOD/Nano1June2019-v1/60000/F608DE48-BBC1-6B4F-9F6B-66A7682536CA.root",
    # "/store/data/Run2016D/MuonEG/NANOAOD/Nano1June2019-v1/240000/B3496D67-7CE0-F341-8069-E9B7753A6CD5.root",
    # "/store/data/Run2016H/MuonEG/NANOAOD/Nano1June2019-v1/30000/CDDE468B-0D61-2A4E-BC5D-2C2C4FFEF0D3.root",
    # "/store/data/Run2016G/MuonEG/NANOAOD/Nano1June2019-v1/60000/F5BFF6B0-3D1C-DB4A-90A3-9C3EFD338A13.root"
