...
TFile *fout = new TFile("systematics_histograms.root","RECREATE");
...
void plotting_test(){
   ...
   //Open and read file
   //TFile *f = new TFile("ZZTo2L2Nu_13TeV_powheg_pythia8.root","READ");
   
   TFile *f = new TFile("condor/2E540096-A45B-CF4F-9C49-8F857335D8DC_Skim.root","READ");
   ...
   p1->cd();
   //prepare event loop
   //TH1D* MET_NOM = (TH1D*)f->Get("measMET_ZZTo2L2Nu_13TeV_powheg_pythia8_catEE");
   //     MET_NOM->SetDirectory(nullptr);
   //TH1D* MET_UP = (TH1D*)f->Get("measMET_ZZTo2L2Nu_13TeV_powheg_pythia8_catEE_sys_PDFUp");
   //     MET_UP->SetDirectory(nullptr);
   //TH1D* MET_DOWN = (TH1D*)f->Get("measMET_ZZTo2L2Nu_13TeV_powheg_pythia8_catEE_sys_PDFDown");
   //     MET_DOWN->SetDirectory(nullptr);

   TH1D* MET_NOM = (TH1D*)f->Get("measMET_ZZTo2L2Nu_13TeV_powheg_pythia8_catMM");
        MET_NOM->SetDirectory(nullptr);
   TH1D* MET_UP = (TH1D*)f->Get("measMET_ZZTo2L2Nu_13TeV_powheg_pythia8_catMM_sys_PrefireWeightUp");
        MET_UP->SetDirectory(nullptr);
   TH1D* MET_DOWN = (TH1D*)f->Get("measMET_ZZTo2L2Nu_13TeV_powheg_pythia8_catMM_sys_PrefireWeightDown");
        MET_DOWN->SetDirectory(nullptr);


   //TH1D* MET_NOM = (TH1D*)f->Get("measMET_ZZTo2L2Nu_13TeV_powheg_pythia8_catEE");
   //     MET_NOM->SetDirectory(nullptr);
   //TH1D* MET_UP = (TH1D*)f->Get("measMET_ZZTo2L2Nu_13TeV_powheg_pythia8_catEE_sys_jerUp");
   //     MET_UP->SetDirectory(nullptr);
   //TH1D* MET_DOWN = (TH1D*)f->Get("measMET_ZZTo2L2Nu_13TeV_powheg_pythia8_catEE_sys_jerDown");
   //     MET_DOWN->SetDirectory(nullptr);
   ...
   leg->AddEntry(MET_UP, "MET_pt_PrefireUp","F");
   leg->AddEntry(MET_DOWN, "MET_pt_PrefireDown","F");
   leg->SetFillColor(0);
   leg->SetFillStyle(0);
   leg->SetLineColor(0);
   leg->SetHeader("");
